...
Student Name\+: Sarah Martin Description\+: Contains an implementation of a \mbox{\hyperlink{class_semaphore}{Semaphore}} class using C++11 features such as mutex and condition variables Date\+: 5/11/2023
...
Usage\+:
\begin{DoxyItemize}
\item Create an instance of \mbox{\hyperlink{class_semaphore}{Semaphore}} with an initial count.
\item Use Wait to block a thread until the semaphore count becomes positive.
\item Use Signal to increment the semaphore count, allowing other threads to proceed.
\end{DoxyItemize}

Example\+: 
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{class_semaphore}{Semaphore}} semaphore(1); \textcolor{comment}{// Initialize semaphore with count 1}}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{// Thread 1}}
\DoxyCodeLine{semaphore.Wait();}
\DoxyCodeLine{\textcolor{comment}{// Perform critical section operations}}
\DoxyCodeLine{semaphore.Signal();}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{// Thread 2}}
\DoxyCodeLine{semaphore.Wait();}
\DoxyCodeLine{\textcolor{comment}{// Perform critical section operations}}
\DoxyCodeLine{semaphore.Signal();}
...
Student Name\+: Description\+: This header file defines a C++ class for implementing a \mbox{\hyperlink{class_semaphore}{Semaphore}} using C++11 features such as mutex and condition variables. Date\+: 5/11/2023
